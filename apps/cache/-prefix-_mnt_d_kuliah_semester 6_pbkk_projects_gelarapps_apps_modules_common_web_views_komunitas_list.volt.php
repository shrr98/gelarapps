        ...
        <div class="card-group">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text"><a href="<?= $this->url->get('komunitas/lihat/' . $item->id) ?>"><?= $item->nama_komunitas ?></a></p>
              <p class="card-text">Kategori : <a href="<?= $this->url->get('komunitas/kategori/' . $item->id_kat) ?>">
                                <?= $item->kategori ?>
                            </a></p>
            </div>
            <?php } ?>
